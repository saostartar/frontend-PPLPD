        ...
        <div className="">
          ...
          >
            <div className=" columns is-multiline is-mobile">
              <div className="column is-full-mobile is-half-tablet is-one-quarter-desktop" style={{ opacity: "70%" }}>
                <div>
                  <div
                    className="card"
                    style={{
          ...
          <div className=" p-3 mt-1">
            ...
            <div className="column is-full-mobile is-half-tablet is-half-desktop mr-2 mb-0 box overflow-x-scroll-mobile" style={{ borderTop: "5px solid #409E31" }}>
              ...
              <div
                className="column ml-2 box overflow-x-scroll-mobile"
